...
const GEO_SIDEBAR_ITEMS = [
  { href: '/china-geo', title: 'Overview', ariaLabel: 'Overview', icon: <TbMapPin className="h-5 w-5" /> },
  { href: '/china-geo/api', title: 'API', ariaLabel: 'API', icon: <TbApi className="h-5 w-5" /> },
  { href: '/china-geo/mcp', title: 'MCP tools', ariaLabel: 'MCP tools', icon: <TbRobot className="h-5 w-5" /> },
  { href: '/china-geo/function-calling', title: 'Function Calling', ariaLabel: 'Function Calling', icon: <TbCode className="h-5 w-5" /> },
  { href: '/china-geo/skill', title: 'Skill', ariaLabel: 'Skill', icon: <TbFileText className="h-5 w-5" /> },
]
...
export default async function GeoLayout(props: Readonly<GeoLayoutProps>) {
  ...
  const sidebarItems = withManageSidebarItem(GEO_SIDEBAR_ITEMS, '/china-geo', isAuthenticated)
