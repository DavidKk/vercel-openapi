...
| **New module from schema**                                    | **First** `.ai/workflow/module-development.md` (five phases: requirements confirmation → customize requirements → requirements breakdown → generate module → raise issues). Then `.ai/schemas/<name>.yaml` + `.ai/rules/layout/module-layout.md`; generator under `.ai/generators/`. |
