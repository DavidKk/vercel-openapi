...
/**
 * Placeholder SVG shown when image fails to load (e.g. in LazyImage).
 */
export function PosterPlaceholder({ title = 'Poster Unavailable', subtitle = 'Click to retry', ...props }: PosterPlaceholderProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox={VIEWBOX} role="img" {...props}>
      <defs>
        <linearGradient id="lazyimg-g1" x1={0} y1={0} x2={1} y2={1}>
          <stop offset="0%" stopColor="#eef2f7" />
          <stop offset="100%" stopColor="#ffffff" />
        </linearGradient>
        <linearGradient id="lazyimg-fold" x1={0} y1={0} x2={1} y2={1}>
          <stop offset="0%" stopColor="#f3f4f6" />
          <stop offset="100%" stopColor="#e5e7eb" />
        </linearGradient>
        <filter id="lazyimg-innerShadow" x="-50%" y="-50%" width="200%" height="200%">
      ...
      <rect width="100%" height="100%" fill="url(#lazyimg-g1)" />
      ...
      <g transform="translate(135,120)">
        ...
        <path d="M120 0 Q150 20 135 50 L150 50 Q150 15 120 0 Z" fill="url(#lazyimg-fold)" opacity={0.95} />
        <g transform="translate(75,125) rotate(45)" fill="#9ca3af" filter="url(#lazyimg-innerShadow)">
